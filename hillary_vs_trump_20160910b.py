...
df_pq = pd.read_parquet('tweets_for_date.2016-09-10.parquet').reset_index()
...
# =============================================================================
df["dominant_topic"] = df["dominant_topic"].replace([1,0], ["Deplorables", "Truth Check"])
# =============================================================================
df[['dominant_topic', 'text']].to_csv('tweets_for_date.2016-09-10.csv')
