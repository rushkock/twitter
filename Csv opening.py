...
# loading the data
import pandas as pd
df = pd.read_csv('allcolumns.csv' , sep=',')
# =============================================================================
# df2 = pd.read_parquet('aug_file.parquet')[0:0]
...
# =============================================================================
# df[['dominant_topic', 'text']].to_csv('dom_topictry.csv')
# =============================================================================

df["dominant_topic"] = df["dominant_topic"].replace([1,2,3,4,5,6], ["Topic name 1", "Topic name 2", "Topic name 3", "Topic name 4", "Topic name 5", "Topic name 6"])
# =============================================================================
